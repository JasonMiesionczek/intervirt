...
class ApiObject {
public:
  ApiObject(std::string name) : name_(name), value_(nullptr) {}
...
ApiObject ExecuteRequest(CURL *client, std::string method,
                         std::string morefType, RequestParams params = {},
                         std::string rawParams = std::string(),
...
ApiObject RetrieveProperties(CURL *client, std::string type,
                             RequestParam object, RequestParams propSet,
...
ApiObject Login(CURL *handle, std::string username, std::string password,
