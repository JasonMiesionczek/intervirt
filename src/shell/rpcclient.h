...
class RpcClient : public jsonrpc::Client
{
    public:
        ...
        std::string connect(const std::string& password, const std::string& uri) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["password"] = password;
            p["uri"] = uri;
        ...
        std::string hostGetVersion(const std::string& connID) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["connID"] = connID;
        ...
        Json::Value getAllVirtualMachines(const std::string& connID) throw (jsonrpc::JsonRpcException)
        {
            Json::Value p;
            p["connID"] = connID;
