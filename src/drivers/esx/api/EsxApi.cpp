...
std::string EsxApi::buildRequest(std::string method, std::string morefType,
...
std::string EsxApi::buildCustomRequest(std::string method,
                                       RequestParam morefType,
...
ApiObject EsxApi::ExecuteRequest(std::string method, std::string morefType,
                                 RequestParams params, std::string rawParams,
...
ApiObject EsxApi::RetrieveProperties(std::string type, RequestParam object,
                                     RequestParams propSet,
                                     RequestParams objSet) {
...
ApiObject EsxApi::getServiceContext() {
  auto serviceContent =
...
void EsxApi::determineHostFolder() {
...
ApiObject EsxApi::Login(std::string username, std::string password) {
