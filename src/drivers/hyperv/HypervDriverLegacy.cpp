...
std::vector<SHRDPTR(Objects::VirtualMachine)> HypervDriverLegacy::getVirtualMachines()
{
    std::vector<SHRDPTR(Objects::VirtualMachine)> vms;

    auto result = this->helper_->Enumerate<Wmi::Classes::V1::Msvm_ComputerSystem, Wmi::Classes::V1::MsvmComputerSystem>();
