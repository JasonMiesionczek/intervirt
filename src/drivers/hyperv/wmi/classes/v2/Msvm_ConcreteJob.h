...
#ifndef V2_MSVM_CONCRETEJOB_H
#define V2_MSVM_CONCRETEJOB_H
        ...
        namespace Wmi {
            namespace Classes {
                namespace V2 {
                    ...
                    #define V2_MSVM_CONCRETEJOB_RESOURCE_URI \
                        "http://schemas.microsoft.com/wbem/wsman/1/wmi/root/virtualization/v2/Msvm_ConcreteJob"
                    
                    #define V2_MSVM_CONCRETEJOB_CLASSNAME \
                        "Msvm_ConcreteJob"
                    
                    #define V2_MSVM_CONCRETEJOB_WQL_SELECT \
                        "select * from Msvm_ConcreteJob "
                    
                    class MsvmConcreteJobMeta : public AbstractWmiObject
                    {
                    public:
                      MsvmConcreteJobMeta();
                    };
