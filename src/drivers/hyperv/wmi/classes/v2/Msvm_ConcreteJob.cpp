...
SER_START_ITEMS(Msvm_ConcreteJob_Data)
    ...
    SER_NS_UINT16(MSVM_CONCRETEJOB_RESOURCE_URI, "CommunicationStatus", 1),
    SER_NS_UINT16(MSVM_CONCRETEJOB_RESOURCE_URI, "DetailedStatus", 1),
    SER_NS_UINT16(MSVM_CONCRETEJOB_RESOURCE_URI, "OperatingStatus", 1),
    SER_NS_UINT16(MSVM_CONCRETEJOB_RESOURCE_URI, "PrimaryStatus", 1),
    ...
    SER_NS_UINT16(MSVM_CONCRETEJOB_RESOURCE_URI, "JobType", 1),
